...
;;;; Last Modified On: Mon Oct  5 20:31:22 1992
;;;; Update Count    : 52
;;;; 
;;;; PURPOSE
...
;;;  5-Oct-92 -FER allowed scroll commands in menu help.
...
(defun sm-pop-up-help (menu)
  ...
  (let ((opt "") (opt-key 'beep)
        ...
        (help-info (cond ((put menu 'help (sm-make-help (get menu 'help-header)
                                                        menu
                                                        (get menu 'items))))
                         ((get menu 'help))
